...
| [🎯 FPS Arena](games/fps-arena/) | three.js 的第一人稱射擊：彈道是真的在飛（有質量、初速、空氣阻力與重力），190 公尺的跑道讓下墜與提前量看得出來。五張地圖各有一種視線結構（開闊長射線 / 環形近戰 / 平行車道 / 死胡同機棚 / 沙暴轉角），三種模式（擊殺競賽 / 陣地戰 / 推進作戰）。開打前可以挑場次規模與同場人數，敵人會找掩體、蹲下、探頭。 |
